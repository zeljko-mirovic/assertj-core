...
/**
 * Test for {@link XmlCommentAssert#isComment()}.  
 * 
 * @author Michał Piotrkowski
 */
public class XmlCommentAssert_isComment_Test extends AbstractXmlNodeAssertTest{

  private Node comment = parseNode("<!-- comment -->");

  @Override
  protected XmlNodeAssert create_original_xml_assertion() {
    return new XmlCommentAssert(comment);
  }
