...
/**
 * Tests for {@link XmlElementAssert#isElement()}.  
 * 
 * @author Michał Piotrkowski
 */
public class XmlElementAssert_isElement_Test extends AbstractXmlNodeAssertTest{

  private Node element = parseNode("<element/>");

  @Override
  protected XmlNodeAssert create_original_xml_assertion() {
    return new XmlElementAssert(element);
  }
